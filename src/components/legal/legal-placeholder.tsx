      ...
      <section className="bg-[var(--surface-page)] pvz-section">
        <div className="mx-auto grid w-full max-w-[760px] gap-5 px-[var(--gutter)] text-center">
          ...
          <p className="text-base leading-7 text-[var(--text-body)]">
            Ta trasa jest placeholderem technicznym dla checkoutu sandbox. Finalna treść prawna wymaga osobnego review przed
            publikacją produkcyjnej sprzedaży.
          </p>
          <Button asChild className="mx-auto">
            <Link href={"/sklep" as Route}>Wróć do sklepu</Link>
          </Button>
        </div>
      </section>
    </ShopShell>
