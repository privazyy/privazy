...
import { approveDocumentForClient } from "@/server/crm/document-operations-service";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    return NextResponse.json(await approveDocumentForClient(documentId, input, actor));
  } catch (error) {
