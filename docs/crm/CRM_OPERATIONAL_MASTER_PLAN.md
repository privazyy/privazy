...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Core CRM architecture | Shared permissions, schemas, errors, pagination, audit | `User`, `AuditLog` | `/admin`, shared helpers | ADMIN/LAWYER/OPERATOR/READ_ONLY | Role smoke | CLIENT blocked, READ_ONLY no mutate | Full IAM admin |
...
| 5 | Commerce ops | Orders/payments/invoices | New models | CRM lists/details | Staff, finance/admin | Provider-safe tests | Safe lists, no raw payloads | Live payments |
