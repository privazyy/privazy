...
| No dedicated DSR workflow | Request view was not a real DSR module | Added DSR data model, portal intake, CRM workflow, deadline and verification foundation | Improved |
| DSR production operations | No notification, attachment, migration execution or legal send flow | Documented as out of scope for this PR | Open |
